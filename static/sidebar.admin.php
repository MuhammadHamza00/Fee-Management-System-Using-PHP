<div class="d-flex grow flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 25%;height:100vh;">
   ...
   <div class="admin"style="display:flex;justify-content:center;align-items:center;flex-direction:column;">
       ...
       <p class="text-muted"><span class="badge bg-primary">Admin</span></p>
   </div>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">

    <li class="nav-item">
        <a id="fee-constraints-link" href="adminpanel.php" class="nav-link text-white">
            <svg class="bi me-2" width="16" height="16">
                <use xlink:href="#home" />
            </svg>
            Fee Constraints Management
        </a>
    </li>

    <li class="nav-item">
        <a id="scholarship-link" href="feetype.admin.php" class="nav-link text-white">
            <svg class="bi me-2" width="16" height="16">
    ...
    <li class="nav-item">
        <a id="complaint-link" href="../form/incop/complaina.php" class="nav-link text-white">
            <svg class="bi me-2" width="16" height="16">
    ...
    <li class="nav-item">
        <a id="operator-link" href="operator.admin.php" class="nav-link text-white">
            <svg class="bi me-2" width="16" height="16">
                <use xlink:href="#grid" />
            </svg>
            Operator Management
...
<script>
    ...
    if (currentUrl.includes("adminpanel")) {
        document.getElementById("fee-constraints-link").classList.add("active");
    } else if (currentUrl.includes("feetype.admin")) {
        document.getElementById("scholarship-link").classList.add("active");
    } else if (currentUrl.includes("complaint")) {
        document.getElementById("complaint-link").classList.add("active");
    } else if (currentUrl.includes("operator.admin")) {
        document.getElementById("operator-link").classList.add("active");
    }
